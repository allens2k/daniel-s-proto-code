...
do{
	...
	if(in=='t'){
		...
		cout<<"i reached false flag";
		 hit=false;
    }
	cout<<"the value of pcv is"<<pcv<<"the value of dcv is"<<dcv;
	}
	//hitsection end here
	//i am not reaching the win condition
	if((pcv<=21 && pcv>dcv)|| (pcv==21 && dcv>pcv)){    //won
		...
		char out1=endgame();
		cout<<"i am at end of end section1";
		if(out1=='t'){
			continue;
		}
	}
	...
	if(pcv==dcv){
		...
		cout<<"your current winnings are :"<<winnings<<endl;
		char out2=endgame();
		cout<<"i am at end of end section2";
		if(out2=='t'){
		continue;
				}
...
//lose
	if((dcv<=21 && dcv>pcv)|| (dcv==21 && pcv>dcv)){          //this is not working
		...
		cout<<"your current winnings are :"<<winnings<<endl;
		char out3=endgame();
		cout<<"i am at end of end section3";
				if(out3=='t'){
				continue;
						}
